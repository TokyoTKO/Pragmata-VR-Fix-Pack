...
The original project-specific scripts and documentation in this repository are licensed under the MIT License, Copyright (c) 2026 WinterWolf. REFramework and all other third-party components remain under their respective licenses; see `notices/`.
