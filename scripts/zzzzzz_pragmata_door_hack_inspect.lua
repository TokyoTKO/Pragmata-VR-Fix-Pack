-- V3: retain confirmed ui3500 suppression; extend matching leaves to ui3510.
-- ui3510 paths/types are checked at runtime; missing/mismatched objects are skipped.
-- Preserve puzzle/button branches, masks, transforms and all other GUIs.
-- Runs on every matching draw, not a first-hack time window.
local prefix='[PragmataHackEffects3] '
local pending,counts,errors={},{},{}
local paths={'main/layout/VFXtex/effecttexture00','main/layout/VFXtex/effecttexture01'}
...
re.on_pre_gui_draw_element(function(element)
    ...
    local ok,err=pcall(function()
        ...
        if name~='ui3500Gui' and name~='ui3510Gui' then return end
...
log.info(prefix..'loaded; ui3500 and ui3510 matching EffectTextures only; original visibility restored after each draw; active for both selected hacking HUDs')
